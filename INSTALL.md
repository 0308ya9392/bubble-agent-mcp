# Install Bubble Agent MCP with your AI agent
...
1. Open the folder for your AI client below.
...
| --- | --- |
| Claude Desktop or Claude Code | [`Claude/INSTALL.md`](Claude/INSTALL.md) |
